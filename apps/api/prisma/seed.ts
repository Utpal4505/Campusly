...
const CLUB_ASSETS_SEED_MAP: Record<string, { logo: string; coverImage: string }> = {
  'seed-club-codingblocks': {
...
const EVENT_COVERS_SEED_MAP: Record<string, string> = {
  'seed-event-sih': 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200&auto=format&fit=crop&q=80',
  'seed-event-hackwave': 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&auto=format&fit=crop&q=80',
  'seed-event-cyberwar': 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&auto=format&fit=crop&q=80',
  'seed-event-aetherax': 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&auto=format&fit=crop&q=80',
  'seed-event-wow': 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=1200&auto=format&fit=crop&q=80',
  'seed-event-youthvibe': 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=1200&auto=format&fit=crop&q=80',
  'seed-event-auroracode': 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=1200&auto=format&fit=crop&q=80',
  'seed-event-robowars': 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=1200&auto=format&fit=crop&q=80',
  'seed-event-kaggle': 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&auto=format&fit=crop&q=80',
  'seed-event-innovatex': 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=1200&auto=format&fit=crop&q=80',
  'seed-event-novicehack': 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1200&auto=format&fit=crop&q=80',
  'seed-event-speedcode': 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=1200&auto=format&fit=crop&q=80',
  'seed-event-designsprint': 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=1200&auto=format&fit=crop&q=80',
  'seed-event-nukkadnatak': 'https://images.unsplash.com/photo-1460723237483-7a6dc9d0b212?w=1200&auto=format&fit=crop&q=80',
  'seed-event-photowalk': 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=1200&auto=format&fit=crop&q=80',
  'seed-event-esportsderby': 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=1200&auto=format&fit=crop&q=80',
  'seed-event-admad': 'https://images.unsplash.com/photo-1557804506-669a67965ba0?w=1200&auto=format&fit=crop&q=80',
  'seed-event-unplugged': 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=1200&auto=format&fit=crop&q=80',
  'seed-event-treeplantation': 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=1200&auto=format&fit=crop&q=80',
  'seed-event-parldebate': 'https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=1200&auto=format&fit=crop&q=80',
};
  ...
  for (const eventData of SEED_EVENTS) {
    const coverImage = EVENT_COVERS_SEED_MAP[eventData.id] || (eventData as any).coverImage || null;
  ...
  for (const clubData of SEED_CLUBS) {
    const assets = CLUB_ASSETS_SEED_MAP[clubData.id];
    const logo = assets?.logo || (clubData as any).logo || null;
    const coverImage = assets?.coverImage || (clubData as any).coverImage || null;
